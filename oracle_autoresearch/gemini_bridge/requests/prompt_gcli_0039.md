...
def compute_eval_weight(
    ...
    """
    # ── MUTATION TARGET ──
    # Incumbent: flat constant. Gemini should explore state-dependent
    # functions here — continuous math, schedules, or asymmetric rules.
    return DIRECT_EVAL_WEIGHT
...
def compute_trace_confidence_multiplier(
    ...
    """
    # ── MUTATION TARGET ──
    # Incumbent: simple linear decay. Gemini should explore non-linear
    # functions, interaction terms, or asymmetric thresholds here.
    multiplier = 1.0 - TRACE_CONFIDENCE_DECAY * n_trace_events
