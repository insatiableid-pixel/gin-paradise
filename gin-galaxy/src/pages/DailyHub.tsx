  ...
  return (
    <div className="space-y-8 pb-20 md:pb-0 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3 px-4 py-2 rounded-xl bg-zinc-900/60 border border-zinc-800/60">
          <Coins className="w-4 h-4 text-amber-500" />
          <span className="text-lg font-bold text-zinc-100">{data.balances.gold_coins.toLocaleString()}</span>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-6 text-sm">
                  <div className="flex items-center gap-1.5 text-zinc-500">
                    ...
                    <span>Best: <strong className="text-zinc-300">{streak.longestStreak}</strong></span>
                  </div>
                  <div className="flex items-center gap-1.5 text-zinc-500">
              ...
              <Card
                ...
                className={cn(
                  ...
                  mission.claimed
                    ...
                    : mission.completed
                      ? "bg-gradient-to-br from-emerald-950/30 to-zinc-900/30 border-emerald-800/40"
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className={cn(
                      ...
                      mission.completed ? "bg-emerald-500/20" : "bg-zinc-800"
                    )}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5">{mission.definition.description}</p>
      ...
      <section className="space-y-4">
        ...
        <Card className="bg-gradient-to-br from-violet-950/30 to-zinc-900/30 border-violet-900/40">
          <CardContent className="p-6">
            <div className="space-y-5">
              {/* Scenario title & description */}
              <div>
                <h3 className="text-lg font-bold text-zinc-100">{puzzle.scenario.title}</h3>
                <p className="text-sm text-zinc-400 mt-1">{puzzle.scenario.description}</p>
              </div>

              {/* Hand display */}
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Your Hand</label>
              ...
              <div className="flex items-center gap-4">
                <div>
                  <label className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Discard Top</label>
                  <div className={cn(
                ...
                <div className="text-sm text-zinc-500">
                  <div>Deadwood: <strong className="text-zinc-300">{puzzle.scenario.deadwood}</strong></div>
              ...
              {!puzzle.completed && !puzzleResult && (
                <div className="space-y-3">
                  <label className="text-xs font-medium text-zinc-500 uppercase tracking-wider">What's Your Move?</label>
                  ...
                  <Button
                    ...
                    className="w-full bg-violet-600 hover:bg-violet-500 text-white font-bold py-3 rounded-xl mt-2"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <div className="text-2xl font-bold text-amber-400">
                  ...
                  <span className="text-sm text-zinc-500 ml-1">/ {data.totalAvailableCoins.toLocaleString()} available</span>
                </div>
        ...
        <Card className="bg-zinc-900/20 border-zinc-800/30">
          <CardContent className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-zinc-300">Gin Paradise Pro</p>
                <p className="text-xs text-zinc-500">Extended puzzle history, bonus rewards, AI coaching</p>
              </div>
            </div>
            <Link to="/premium">
